...
![The new gate sprite named in the sprite panel](images/gate-name.png)

## Step 2

Match the fill colour to the wooden barriers.

![The colour picker set to the barrier brown](images/brown-hsv.png)
...
![The gate drawing centred on the costume canvas](images/boat-center.png)
